...
PICS = (environ.get('PICS', 'https://i.postimg.cc/nz450KMb/DSW-BRNREQAASTLT.jpg')).split() # Bot Start Picture
...
DB_URI = environ.get("DB_URI", "mongodb+srv://pegab42884:pegab42884@cluster0.0fgdr.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DB_NAME = environ.get("DB_NAME", "filestreamerbot")
...
WEBSITE_URL = environ.get("WEBSITE_URL", "https://ophackz.com/") # For More Information Check Video On Yt - @Tech_VJ
