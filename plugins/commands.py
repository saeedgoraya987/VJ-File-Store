        ...
        if AUTO_DELETE_MODE == True:
            ...
            for x in filesarr:
                try:
                    ...
                    pass
            await k.edit_text("<b>Yᴏᴜʀ Aʟʟ Fɪʟᴇs/Vɪᴅᴇᴏs Is Sᴜᴄᴄᴇssғᴜʟʟʏ Dᴇʟᴇᴛᴇᴅ!!!</b>")
        return
        ...
        try:
            ...
            if AUTO_DELETE_MODE == True:
                ...
                try:
                    ...
                    pass
                await g.delete()
                await k.edit_text("<b>Yᴏᴜʀ Fɪʟᴇ/Vɪᴅᴇᴏ Is Sᴜᴄᴄᴇssғᴜʟʟʏ Dᴇʟᴇᴛᴇᴅ!!!</b>")
            return
        except:
            pass
...
async def shortener_api_handler(client, m: Message):
    ...
    if len(cmd) == 1:
        ...
        await m.reply("<b>Sʜᴏʀᴛᴇɴᴇʀ Aᴘɪ Uᴘᴅᴀᴛᴇᴅ Sᴜᴄᴄᴇssғᴜʟʟʏ Tᴏ</b> " + api)
...
async def base_site_handler(client, m: Message):
    ...
    if len(cmd) == 1:
        ...
        if base_site == None:
            ...
            return await m.reply("<b>Bᴀsᴇ Sɪᴛᴇ ᴜᴘᴅᴀᴛᴇᴅ Sᴜᴄᴄᴇssғᴜʟʟʏ</b>")
            
        if not domain(base_site):
            return await m.reply(text=text, disable_web_page_preview=True)
        await update_user_info(user_id, {"base_site": base_site})
        await m.reply("<b>Bᴀsᴇ Sɪᴛᴇ ᴜᴘᴅᴀᴛᴇᴅ Sᴜᴄᴄᴇssғᴜʟʟʏ</b>")
